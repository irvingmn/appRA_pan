...
public class BarPlotExampleActivity extends Activity
{
   ...
   private static final String NO_SELECTION_TXT = "Toca la grafica para seleccionar";
    private XYPlot plot;
    ...
    private MyBarFormatter formatter1 =
            new MyBarFormatter(Color.argb(149, 211, 199, 200), Color.MAGENTA);

    private MyBarFormatter formatter2 =
            new MyBarFormatter(Color.argb(200, 100, 100, 150), Color.RED);

    private MyBarFormatter selectionFormatter =
            new MyBarFormatter(Color.GREEN, Color.RED);
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        spSeriesSize.setSelection(SeriesSize.DIEZ.ordinal());
    ...
    private void updatePlot() {
        ...
        series1 = new SimpleXYSeries(Arrays.asList(series1Numbers), SimpleXYSeries.ArrayFormat.Y_VALS_ONLY, "YO");
        series2 = new SimpleXYSeries(Arrays.asList(series2Numbers), SimpleXYSeries.ArrayFormat.Y_VALS_ONLY, "ELLOS");
    ...
    private void onPlotClicked(PointF point) {
        ...
        if(selection == null) {
            ...
            selectionWidget.setText("Seleccionado: " + selection.second.getTitle() +
